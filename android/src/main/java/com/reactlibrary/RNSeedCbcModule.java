...
public class RNSeedCbcModule extends ReactContextBaseJavaModule {
  ...
  protected static native int seedCBCInit(byte[] paramArrayOfByte, int[] paramArrayOfInt);
  ...
  protected static native void encryptBlock(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, int[] paramArrayOfInt);
